...
// I hate this loader but here we are
// I will write a better one in the future
// This one is from http://www.opengl-tutorial.org/beginners-tutorials/tutorial-7-model-loading/
bool loadOBJ(
    const char *path,
    ...
    std::vector<unsigned int> &out_indices)
{
    ...
    while (1)
    {
        ...
        else if (strcmp(lineHeader, "f") == 0)
        {
            ...
            if (matches != 9)
            {
                printf("Error reading file, format not supported\n");
                fclose(file);
                return false;
            }
