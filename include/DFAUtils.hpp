...
//                                                                  !isEqual<T, T2>() && isUniqueTransition<T,
//                                                                  Ts...>::value>
// {
// };
...
// template <class T, class... Ts>
// struct DFACheck<T, Ts...> : std::integral_constant<bool, isUniqueTransition<T, Ts...>::value &&
// DFACheck<Ts...>::value>
// {
// };
...
//             if (printDebugInfo)
//             {
//                 std::cout << transition.from << " --(" << (transition.symbol == e ? std::string("e") :
//                 std::to_string(transition.symbol)) << ")--> " << transition.to << "\n";
//             }
//         }
...
//             std::cout << u.state << " --(" << (u.symbol == e ? std::string("e") : std::to_string(u.symbol)) << ")-->
//             " << transition.to << "\n";
//         }
//     }
// };